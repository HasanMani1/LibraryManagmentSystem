...
SELECT br.borrowing_id, u.name AS user_name,
       ...
       br.borrow_date, br.due_date, br.returned_date, br.status_id
FROM borrowing br
...
<div class="container">
    ...
    <form class="filter-bar" method="GET">
        ...
        <button type="submit" class="btn btn-approve"><i class="bi bi-search"></i> Search</button>
    </form>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $row['due_date']; ?></td>
                <td><?= $row['returned_date'] ? $row['returned_date'] : '---'; ?></td>
                <td>
                    <?php
                        if ($row['status_id'] == 0) echo "<span style='color:orange;'>Pending</span>";
                ...
                <td>
                    <?php if($row['status_id'] == 0): ?>
                        <form method="POST">
                            ...
                            <button type="submit" name="approve" class="btn btn-approve"><i class="bi bi-check-circle"></i> Approve</button>
                        </form>
                    <?php else: ?>
                        ---
                    <?php endif; ?>
